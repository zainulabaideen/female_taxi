      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#e1cfe6]">
        <div className="w-full max-w-md">
          ...
          <div className='flex gap-3 items-center mb-2'>
            <Link to="/">
              <ArrowLeft className="text-[#402763] w-7 h-7 hover:-translate-x-1 transition" />
            </Link>
            <h1 className="text-3xl font-black text-[#402763]">Sign In</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3.5 rounded-xl border border-[#402763] bg-white text-[#402763] placeholder-[#402763]/30 focus:outline-none focus:ring-2 focus:ring-[#402763]/20 transition-all duration-200 text-sm"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-3.5 pr-12 rounded-xl border border-[#402763] bg-white text-[#402763] placeholder-[#402763]/30 focus:outline-none focus:ring-2 focus:ring-[#402763]/20 transition-all duration-200 text-sm"
                />
                <button
                  type="button"
