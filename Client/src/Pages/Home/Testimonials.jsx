...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'SHEGO has completely changed how I commute. I feel safe knowing my caption is a verified woman, and the SOS feature gives my parents peace of mind. Absolutely love this service!',
    avatar: 'FZ',
    bg: 'from-[#402763] to-[#5a3585]',
  },
  {
    name: 'Ayesha Malik',
    role: 'Caption Partner — Lahore',
    rating: 5,
    text: 'Being a SHEGO caption has given me financial independence while working safe, flexible hours. The schedule management tool is so easy to use. Highly recommend to all women!',
    avatar: 'AM',
  ...
  },
  {
    ...
    role: 'Passenger — Lahore',
    rating: 5,
    text: 'The best thing about SHEGO is that I can see the caption\'s schedule before booking. The time slot system is genius! No more waiting around for a ride that never shows.',
    avatar: 'NK',
