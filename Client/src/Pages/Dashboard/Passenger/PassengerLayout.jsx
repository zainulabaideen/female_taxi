      ...
      >
        ...
        <div className="px-6 py-6 border-b border-white/10">
          ...
          <div className="mt-3 inline-flex items-center gap-1.5 bg-white/10 border border-white/20 rounded-full px-3 py-1">
            ...
            <span className="text-[#e1cfe6] text-xs font-bold">
              Passenger Portal
            </span>
          </div>
        </div>
        ...
        <div className="px-4 py-5 border-t border-white/10">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-white/60 hover:bg-white/10 hover:text-white text-sm font-semibold transition-all"
          >
            <LogOut size={18} />
            Sign Out
          </button>
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        <header className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between sticky top-0 z-20">
          ...
          <div className="hidden lg:block">
            ...
            <p className="text-[#402763] font-bold">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/dashboard/passenger/emergency"
              className="px-4 py-1.5 bg-red-500 text-white text-xs font-bold rounded-lg flex items-center gap-1.5 hover:bg-red-600 transition animate-pulse"
            >
              <AlertTriangle size={13} /> SOS
            </Link>
            <div className="w-9 h-9 bg-gradient-to-br from-[#e1cfe6] to-[#402763] rounded-full flex items-center justify-center text-white text-xs font-black">
              P
            </div>
          </div>
        </header>
